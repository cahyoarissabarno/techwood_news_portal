...
<div class="row mx-auto px-4 py-5 my-5 mx-lg-5">
		<div class="col">
			...
			<div class="text-justify" style="font-size: 20px;">
				<p><span class="text-warning"><b class="bg-dark px-2">Cinematec</b></span> adalah media informasi digital mengenai penggunaan dan perkembangan dunia teknologi yang berperan dalam memajukan industri pembuatan film dunia, khususnya pada perfilman Hollywood yang <u class="main-title">dirangkum dari berbagai sumber</u>.</p><br>
				<h3>SOURCE :</h3>
				<hr>
				<ul>
					<li>
						...
						<ul>
							<li>
								<small style="word-wrap:break-word;">https://www.universalstudioshollywood.com/tridiondata/ush/en/us/files/images/universal-studio-tour-art-V2-2800x1197-a.jpg?imwidth=580</small>
							</li>	
						</ul>
					</li>
					<br>
					<li>
						...
						@foreach($articles as $article)
							<li><small style="word-wrap:break-word;">{{$article->sumber}}</small></li>
						@endforeach
						</ul>
					</li>
				</ul>
