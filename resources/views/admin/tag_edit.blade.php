...
@section('content')
    <div class="pt-2 pr-5">
        ...
        <form class="form-inline pl-5 ml-5 mb-3 float-left" method="post" action="{{ route('tag.update', $tags->id) }}"> 
            @csrf
            <input type="hidden" name="_method" value="PATCH">
            <input class="form-control mr-sm-2" type="text" name="tag" value="{{ $tags->tag }}" placeholder="Tambah Tag ...." autofocus>
            <input type="submit" value="Ubah Tag" class="btn btn-primary">
        </form>
    </div>
